...
export default function Home() {
  return (
    <div className="flex flex-col">
      <Header />
      <section id="2-Section" className=" py-3 md:py-7">
        <div className="flex flex-col font-roboto">
          <div className="flex justify-center text-center text-xs md:text-base">
            ...
            <div className="w-1/2 flex justify-center h-screen">
              <div className=" flex flex-col flex-wrap content-center h-full">
                <div className="w-2/3 flex flex-col flex-grow justify-center">
                  <h1 className="lg:text-3xl xl:text-4xl 2xl:text-5xl">
                  Lorem ipsum odor amet, consectetuer adipiscing elit. Fames imperdiet conubia urna eget amet.
                  </h1>
                </div>
                <div className="flex flex-col flex-grow justify-center">
                  <div className="">
                    <h1 className="lg:text-4xl xl:text-5xl 2xl:text-6xl text-rojoprincipal font-extrabold">Toros Mecanicos</h1>
                  </div>
                  <div className="pt-14">
                    <a href="#">
                      <div className="lg:text-3xl xl:text-4xl 2xl:text-5xl font-medium border-rojoprincipal text-rojoprincipal border-2 px-12 py-1.5 inline-block text-center z-40">
                        Descubir
                      </div>
                      <div className="lg:w-[13.5rem] lg:h-[52px] xl:w-60 xl:h-[54px] 2xl:w-72 2xl:h-[60px]  bg-rojoprincipal opacity-20 absolute translate-x-4 -translate-y-11 z-0 hover:translate-x-0 lg:hover:-translate-y-[54px] xl:hover:-translate-y-[56px]  2xl:hover:-translate-y-[62px] transition-transform duration-500"></div>
                    </a>
                  </div>
                </div>
              </div>
