      ...
      <div className="flex flex-col font-roboto">
        ...
        <div className="flex flex-row-reverse pt-10 md:pt-14 md:flex-row space-x-5 md:space-x-[20%]">
          ...
          <div className=" w-full h-full md:max-h-none md:w-1/3 flex justify-end">
            <div className="hidden md:flex rounded-md h-3/4 w-1/6 z-0 bg-rojoprincipal opacity-50 absolute justify-start lg:translate-y-[4%] lg:-translate-x-[100%] transition-transform "></div>
            <Image
              width={Infinity}
              height={Infinity}
              src={ImageBull}
              alt="ImageHeaderBull_1"
              className="z-10 rounded-md rounded-br-none md:rounded-s-md"
            ></Image>
          </div>
        </div>
      </div>
